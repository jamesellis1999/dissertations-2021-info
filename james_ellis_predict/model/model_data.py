...
def model_data(tc, ts, tf, wws_centrality=None, syn_centrality=None, wws_binary=False, syn_binary=False, cb_rank=False, save_path=None):
    '''
    ...
    fund = funding_info(tc, ts, syn_centrality=syn_centrality, syn_binary=syn_binary, cb_rank=cb_rank)
...
if __name__=="__main__":
    ...
    # Binarize the network features
    # model_data(*dates, wws_centrality='closeness', syn_centrality='eigenvector', wws_binary=True, syn_binary=True, save_path='model_data/baseline+wws+syn/data_binary.csv')

    # Use CB rank instead of syndicate network
    model_data(*dates, wws_centrality='closeness', cb_rank=True, save_path='model_data/baseline+wws+syn/data_closeness_cbrank.csv')